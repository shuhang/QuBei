...
import com.pku45a.difference.module.ShuHang.Tab2.Activity.MyHomeActivity;
import com.pku45a.difference.module.home.activity.SearchActivity;
import com.pku45a.difference.module.home.activity.UserArticleActivity;
import com.pku45a.difference.module.home.model.BannerBean;
import com.pku45a.difference.module.home.presenter.HomePresenter;
import com.pku45a.difference.module.home.view.HomeView;
...
import com.pku45a.difference.module.main.dialog.WebDialog;
...
//                    WebActivity.start(getContext(), bean.getTitle(), bean.getUrl());
                    MyHomeActivity.start(getContext());
                }
            });
