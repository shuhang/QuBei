package com.pku45a.difference.module.home.model;
...
public class HomeRequest extends BaseRequest {
    public static void getHomeList(RxLife rxLife, boolean refresh, int userId, int page, int type, @NonNull RequestListener<List<HomeEntity>> listener) {
        cacheAndNetList(rxLife,
                WanApi.api().getHomeList(userId, page, type),
                refresh,
                "api/user/getAll",
                HomeEntity.class,
                listener);
