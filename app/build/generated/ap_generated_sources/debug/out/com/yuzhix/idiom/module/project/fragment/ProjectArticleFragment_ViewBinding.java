...
package com.yuzhix.idiom.module.project.fragment;
...
public class ProjectArticleFragment_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ProjectArticleFragment_ViewBinding(ProjectArticleFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProjectArticleFragment target = this.target;
