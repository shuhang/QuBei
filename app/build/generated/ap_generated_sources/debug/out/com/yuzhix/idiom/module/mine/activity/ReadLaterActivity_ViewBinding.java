...
public class ReadLaterActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public ReadLaterActivity_ViewBinding(ReadLaterActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ReadLaterActivity_ViewBinding(ReadLaterActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReadLaterActivity target = this.target;
