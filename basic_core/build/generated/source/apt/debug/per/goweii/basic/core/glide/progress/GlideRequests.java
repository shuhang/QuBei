...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof per.goweii.basic.core.glide.progress.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new per.goweii.basic.core.glide.progress.GlideOptions().apply(toSet));
    }
  }
}
